...
export class QuestionDataFreetextService {
  ...
  async createFreeTextQuestion(
    ...
    questionId: number,
  ): Promise<detailedFreetextQuestionDTO> {
  ...
  async updateFreeTextQuestion(
    ...
    const updatedFreeTextQuestion = await this.prisma.freeTextQuestion.update({
      ...
      data: {
        ...
        expectations: freeTextQuestion.expectations,
        expectationsHTML:
          freeTextQuestion.expectationsHTML || originalFreeTextQuestion.expectationsHTML,
        exampleSolution:
          freeTextQuestion.exampleSolution || originalFreeTextQuestion.exampleSolution,
        exampleSolutionHTML:
          freeTextQuestion.exampleSolutionHTML || originalFreeTextQuestion.exampleSolutionHTML,
      },
    });
