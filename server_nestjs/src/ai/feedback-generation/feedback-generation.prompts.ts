export const feedbackGenerationPrompts = {
    freeText: (question: string, lecture: string) => `
        ...
        - Überlege dir zunächst selbst eine Antwort auf die Frage anhand der genannten Informationen. 
        ...
        - Nenne bei falschen oder fehlenden Teilen der Antwort nur das Oberthema oder den Oberbegriff, unter welchem der Aspekt fallen würde.
        - Nenne nicht die Lösung.
