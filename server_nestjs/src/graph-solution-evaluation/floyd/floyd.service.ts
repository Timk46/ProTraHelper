...
export class FloydService {
    ...
    async evaluateSolution(questionText: string, initialStructure: GraphStructureDTO, studentSolution: GraphStructureDTO[], maxPoints: number) {
        ...
        const expectedSolutionSemantic: GraphStructureSemanticDTO[] = this.solveFloyd(initialStructureSemantic, nodesOrder);
        ...
        for (let stepIndex = 0; stepIndex < studentSolution.length; stepIndex++) {
            ...
            const prevExpectedStep: GraphStructureSemanticDTO = stepIndex > 0 ? expectedSolutionSemantic[stepIndex - 1] : initialStructureSemantic;
     ...
     */
    solveFloyd(initalStructure: GraphStructureSemanticDTO, nodesOrder: string[]): GraphStructureSemanticDTO[] {
     ...
     */
    getNodesOrder(solution: GraphStructureSemanticDTO[]): { continueEvaluation: boolean, nodesOrder: string[], feedback: string } {
