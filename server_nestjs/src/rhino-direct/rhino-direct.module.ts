...
@Module({
  ...
  providers: [RhinoDirectService, RhinoWindowManagerService, RhinoNativeFocusService],
  exports: [RhinoDirectService, RhinoWindowManagerService, RhinoNativeFocusService],
})
