...
- Address the student **informally** as "Du" (you) instead of **in the** third person (e.g., "Der Student"). **For example**: "Du hast" instead of "Der Student hat".
- Use simple, beginner-friendly language that is easy to understand, especially for someone new to programming. Keep your tone always constructive and friendly.
- Respond in German.
      ...
      try {
        const newFeedback = await this.prisma.generatedFeedback.create({
          data: {
            ...
            finalPrompt: systemPrompt, // Store the combined prompt
