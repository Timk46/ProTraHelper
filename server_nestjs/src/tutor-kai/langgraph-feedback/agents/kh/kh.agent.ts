...
/**
 * KH: Knowledge of How to Fix Agent
 * Provides hints or guidance on *how* to correct the identified mistake.
 */
export const knowledgeOnHowToProceedAgent = createFeedbackAgent(
  'KH',
  `You are the Knowledge of How to Fix (KH) agent.
