...
export const seedCodeQuestions = async (user_id: number) => {
  await importProgrammingTasksFromExcel(
    'programming-tasks/programmieraufgaben_JACK_SOSE23_WORKSHOP_WISE2324.xlsx',
    'Automatisch Import aus Excel: JACK Aufgaben aus SoSe 23 + Workshopsaufgaben aus WiSe 23/24',
    user_id,
  );
  await importProgrammingTasksFromExcel(
    'programming-tasks/programmieraufgaben_bechtel.xlsx',
    'Automatisch Import aus Excel: Aufgaben aus dem TutorKai-Einsatz in Schulen von Herrn Bechtel WiSe 23/24',
    user_id,
  );
  await importProgrammingTasksFromExcel(
    'programming-tasks/programmieraufgaben_linden.xlsx',
    'Automatisch Import aus Excel: Aufgaben aus dem TutorKai-Einsatz in Schulen von Frau Linden WiSe 23/244',
    user_id,
  );
  await importProgrammingTasksFromExcel(
    'programming-tasks/programmieraufgaben_basicTasks_genByGPT_sven.xlsx',
    'Automatisch Import aus Excel: Einfache Aufgaben generiert von Sven Jacobs und einem GPT',
    user_id,
  );
};

async function importProgrammingTasksFromExcel(
  filename: string,
  description: string,
  adminUserId = 1,
) {
              ...
              create: [
                {
                  ...
                  testFileName: task.testClassName, // refactoring needed
