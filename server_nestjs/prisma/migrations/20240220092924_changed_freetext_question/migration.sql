...
-- AddForeignKey
ALTER TABLE "UserAnswer" ADD CONSTRAINT "UserAnswer_freeTextQuestionId_fkey" FOREIGN KEY ("freeTextQuestionId") REFERENCES "FreeTextQuestion"("id") ON DELETE SET NULL ON UPDATE CASCADE;
