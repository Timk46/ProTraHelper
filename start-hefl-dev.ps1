...
Write-Host "[1/5] Suche Cursor IDE..." -ForegroundColor Cyan
$cursorPaths = @(
...
# 1. Cursor IDE (startet als erstes)
Write-Host "Starte Cursor IDE mit HEFL-Projekt..." -ForegroundColor White
if ($cursorPath) {
...
# 3. GitHub Desktop (with HEFL repository)
...
Write-Host "  - Cursor IDE geoeffnet mit HEFL-Projekt"
Write-Host "  - Terminals koennen manuell im Cursor geoeffnet werden (Strg+Shift+` oder '+' Symbol)"
