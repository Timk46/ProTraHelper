...
export const umlLineOptions: { [key: string]: {normal: lineOptions, highlight?: lineOptions} } = {
  [EditorElement.CD_GENERALISATION]: {      //      ________|>
    normal: {
      size: 5,
      lineColor: "black",
      dash: undefined,
  ...
  //TODO edgeType.usage                     //      -------->    <<use>>
   [EditorElement.CD_ASSOCIATION]: {                 //      ________
    normal: {
      size: 5,
      lineColor: "black",
      dash: undefined,
  ...
  [EditorElement.CD_DIRECTIONAL_ASSOCIATION]: {      //      ________>
    normal: {
      size: 5,
      lineColor: "black",
      dash: undefined,
  ...
  [EditorElement.CD_BIDIRECTIONAL_ASSOCIATION]: {    //     <________>
    normal: {
      size: 5,
      lineColor: "black",
      dash: undefined,
  ...
  [EditorElement.CD_AGGREGATION]: {                 //      ________<  >
    normal: {
      size: 5,
      lineColor: "black",
      dash: undefined,
  ...
  [EditorElement.CD_COMPOSITION]: {                 //      ________<<>>
    normal: {
      size: 5,
      lineColor: "black",
      dash: undefined,
