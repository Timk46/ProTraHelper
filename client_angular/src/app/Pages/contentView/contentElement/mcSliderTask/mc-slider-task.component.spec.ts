...
describe('McSliderTaskComponent', () => {
  ...
  beforeEach(async () => {
    ...
    mockQuestionDataService = TestBed.inject(QuestionDataService) as jasmine.SpyObj<QuestionDataService>;
    mockDialogRef = TestBed.inject(MatDialogRef) as jasmine.SpyObj<MatDialogRef<McSliderTaskComponent>>;
    ...
    mockQuestionDataService.createUserAnswer.and.returnValue(of({
      id: 1,
      userAnswerId: 1,
      score: 10,
